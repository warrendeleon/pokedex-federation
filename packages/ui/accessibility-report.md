...
|---|---|---|---|---|
| 1.1.1 | Non-text Content <br/><sub>image alt / decorative (quality is manual)</sub> | A | Automated (Jest) | ✅ pass (1) |
...
| 1.3.1 | Info and Relationships <br/><sub>semantic roles (header, etc.)</sub> | A | Automated (Jest) | ✅ pass (1) |
...
| 1.3.5 | Identify Input Purpose <br/><sub>no text inputs in this app</sub> | AA | N/A | - n/a |
| 1.4.1 | Use of Color <br/><sub>non-colour cue present (perception is manual)</sub> | A | Automated (Jest) | ✅ pass (2) |
...
| 2.4.3 | Focus Order <br/><sub>focusable elements (real order is manual)</sub> | A | Automated (Jest) | ✅ pass (1) |
| 2.4.4 | Link Purpose (In Context) <br/><sub>no links; navigation is native buttons</sub> | A | N/A | - n/a |
...
| 2.5.3 | Label in Name <br/><sub>accessible name contains visible text</sub> | A | Automated (Jest) | ✅ pass (1) |
...
| 3.3.1 | Error Identification <br/><sub>no text inputs in this app</sub> | A | N/A | - n/a |
| 3.3.2 | Labels or Instructions <br/><sub>no text inputs in this app</sub> | A | N/A | - n/a |
