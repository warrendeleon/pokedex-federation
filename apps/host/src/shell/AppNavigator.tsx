...
function PokedexTabScreen() {
  return <FederatedTabBoundary name="Pokédex" remoteName="listApp" load={loadList} />;
}
...
function RegionsTabScreen() {
  return (
    <FederatedTabBoundary name="Regions" remoteName="regionsApp" load={loadRegions} />
  );
}

function Tabs() {
  return (
    <Tab.Navigator screenOptions={{headerShown: false, tabBarActiveTintColor: '#3A86FF'}}>
      <Tab.Screen
        name="PokedexTab"
